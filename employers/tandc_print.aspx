<%@ Page Language="C#" MasterPageFile="~/Site.master" Title="Ambassador Recruitment - Terms and Conditions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_Main" Runat="Server">
    <div id="singlecolumnpadding">
	    <h1>Terms and Conditions of Business</h1>
	    <p>Ambassador Recruitment <b>(the Agency)</b>
	    is in the business of providing and recruiting personnel for 
	    the Hotel &amp; Catering Industry. Our roles include job placement: 
	    the sourcing, screening and evaluating of candidates, the presenting 
	    of such persons (candidates for interview), and acting as a
	    mediator between employers and candidates.</p>
